...
#                if add_sec == del_sec and (add_pos - del_pos < 5) and (add_pos > del_pos) and (add_context > del_context) and (add_context - del_context < 5):
                if (add_call[2] - del_call[1] <= 5) and (add_call[2] > del_call[1]):
