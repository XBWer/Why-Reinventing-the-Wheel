...
if __name__ == '__main__':
    diff_list = list()
    with open('665d5d4.txt') as f:
        reader = f.read().split('\n')
        for line in reader:
            diff_list.append(line)
    
    removed_func_list = removedFunctions(diff_list)
    print removed_func_list
    
    print ''
    print '*'*100
    removed_invocations = removedInvocations(diff_list, removed_func_list)
